...
public class MainListFragment2 extends BaseFragment implements NodesView {
    ...
    public void showNodes(List<ResponseNodes.DataBean.NodesBean> nodes) {
        Log.d("MainListFragment2", nodes.get(0).getTitle());
        recyclerAdapter.addDatas(nodes);
    }

    @Override
    public void showLoadFailed() {
        Log.d("MainListFragment2", "showLoadFailed");
    }
